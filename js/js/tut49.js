...
This character means any digit character; functionally equivalent to [0-9] or [[:digit:]]

\d matches 1,56,77 12, 123, etc., but not 1b7 or aabb6. One or more of any digit characters.

\D

This character means any non-digit character; functionally equivalent to [^0-9] or [^[:digit:]]

\D matches a, ab, abcd, ab&, but not 1.

\w

This character means any "word" character. That is, any alphanumeric character and its functionally equivalent to [_A-Za-z0-9] or [_[:alnum:]]
...
This character means any non-alphanumeric character; functionally equivalent to [^_A-Za-z0-9] or [^_[:alnum:]]
...
This character means any non-whitespace character; anything other than space, newline, tab, non-breaking space, etc.; functionally equivalent to [^[: space]]
...
An Assertion is a regular expression that will succeed if a match is found and fails if a match is not found. Assertion consists of Anchors and Lookarounds.
 ...
 let regex = /\w ar/; //word character - _ or alphabet or numbers
...
str = "harh7rd1r4r5ry%%$@bhai hdrryika number 899999harry9999";
 ...
 str = "harh7rd1r4r5ry%%$@bhai hdrryi      ka number 899999harry9999ka number";
